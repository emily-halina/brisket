...
class FightingiceEnv_Data_NoFrameskip(gym.Env):
    ...
    def __init__(self, **kwargs):
        ...
        start_jar_path = os.path.join(self.java_env_path, "FightingICE_nonDelay.jar")
    ...
    def _start_java_game(self):
        try:
            ...
            print("exception in start java game")
            print(e)
    ...
    def _start_gateway(self, p2=RandomAI):
        try:
        ...
        try:
            ...
            if self.game_started is False:
                try:
                    ...
                    print("error closing gateway / game")
